  ...
  return (
    <AnimatePresence>
      {visible ? (
        ...
        >
          <div aria-hidden="true" className="living-cosmos absolute inset-0" />
          <div aria-hidden="true" className="starfield starfield-drift absolute inset-0 opacity-70" />
          ...
          >
            ...
            <p className="mt-8 text-xs uppercase tracking-[0.5em] text-[var(--muted-soft)]">Código do Destino</p>
            <h1 className="mt-5 max-w-4xl text-balance text-5xl font-semibold leading-[0.88] text-[var(--fg)] sm:text-7xl">
              A esfera está abrindo o seu mapa.
            </h1>
